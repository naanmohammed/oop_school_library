...
**OOP School Library** is a school library project that implements an OOP app that interacts with users when inserting data.
...
git clone https://github.com/naanmohammed/oop_school_library.git
